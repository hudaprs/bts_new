	...
	return (
		<div className='px-6 md:px-24 py-10 font-primary'>
			<div className="grid grid-cols-1 md:grid-cols-2 gap-10">
				<div>
					<h3 className='text-center md:text-left text-3xl md:text-5xl w-full mb-6	'>
				...
				<div>
					<img src={IndustrySolutionImage} alt="Industry Solution" className='rounded hidden md:block'/>
				</div>
			</div>
		</div>
	)
